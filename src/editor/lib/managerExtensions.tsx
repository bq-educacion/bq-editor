...
import { BoldExtension, BulletListExtension, CodeBlockExtension, CodeExtension, HeadingExtension, ItalicExtension, LinkExtension, MarkdownExtension, OrderedListExtension, PlaceholderExtension } from "../extensions";
...
const managerExtensions = ({
  ...
  return () => [
    ...
    ...(extensionsFlat.includes("codeBlock") ? [new CodeBlockExtension({
      defaultLanguage: codeLanguage,
      supportedLanguages: [langCss, langJavascript, langJson, langMarkdown, langTypescript],
